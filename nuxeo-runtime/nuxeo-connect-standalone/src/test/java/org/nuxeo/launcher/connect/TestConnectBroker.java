...
public class TestConnectBroker extends LocalServerTestBase {
    ...
    public void testHotfixPackageRequest() throws Exception {
        ...
        assertEquals("Download of 'hfC-1.0.0-SNAPSHOT' will replace the one already in local cache.",
                caughtEvents.get(0).getRenderedMessage());
        assertEquals("Downloading [hfC-1.0.0-SNAPSHOT]...", caughtEvents.get(1).getRenderedMessage());
        assertEquals("Replacement of hfC-1.0.0-SNAPSHOT in local cache...", caughtEvents.get(2).getRenderedMessage());
        assertEquals("Added hfC-1.0.0-SNAPSHOT", caughtEvents.get(3).getRenderedMessage());
        assertEquals(
